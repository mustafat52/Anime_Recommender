...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiement = comet_ml.Experiment(
             api_key="egrLTq7mqb5v0GwC8gXYcWAcq",
             project_name = "anime_mlops02",
             workspace="012-mustafa"
        )
        logger.info("-----------MODEL TRAINING AND COMET ML INTIALIZED--------------")
    ...
    def extract_weights(self,layer_name, model):
        try:
             ...
             return weights
                ...
                logger.error(str(e))
                raise CustomException("Error during extraction of weights",e)
    ...
    def save_model_weights(self,model):
        try:
            ...
            logger.info("User and Anime weights saved Sucesfully........")
                ...
                logger.error(str(e))
                raise CustomException("Error during saving of weights",e)

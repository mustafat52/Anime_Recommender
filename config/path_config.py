...
ANIME_DF = "artifacts/raw/anime.csv"
ANIME_SYNOPSIS_DF = "artifacts/raw/anime_with_synopsis.csv"
...
SYNOPSIS_PATH = os.path.join(PROCESSED_DIR, "synopsis_df.csv")
...
CHECKPOINT_FILE_PATH = "artifacts/model_checkpoint/weighrs.weights.h5"
